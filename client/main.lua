...
AddEventHandler('esx_adminjob:hasEnteredMarker', function(station, part, partNum)
  ...
  if part == 'HelicopterSpawner' then
    ...
    local helicopters = Config.AdminStations[station].Helicopters
...
AddEventHandler('esx_adminjob:hasEnteredEntityZone', function(entity)
  ...
  if PlayerData.job ~= nil and PlayerData.job.name == 'admin' and not IsPedInAnyVehicle(playerPed, false) then
